...
# Training on Blacktower

Blacktower trains the learned motor-control portion of the MaleCNS-derived network using PyTorch/CUDA on its RTX 4090. The Mac supplies rendered Front/Gripper observations and performs RealityKit evaluation. The GPU does not run the macOS simulator.

All remote code, caches, training inputs and outputs live under `/home/monomyth/code/codex/fly-brain`. All local generated artifacts live under `/Users/monomyth/code/codex/fly-brain`. Original downloaded connectome data remain in shared storage; generated data do not go there.
...
rsync -a scripts/continue_head_training.py \
  blacktower.local:/home/monomyth/code/codex/fly-brain/experiments/priority-recovery-20260911-151700/
ssh blacktower.local 'cd /home/monomyth/code/codex/fly-brain && \
  .venv-cuda/bin/python experiments/priority-recovery-20260911-151700/continue_head_training.py \
  --iterations 8000 \
  --output /home/monomyth/code/codex/fly-brain/experiments/priority-recovery-20260911-151700/continued-new-run'
```
